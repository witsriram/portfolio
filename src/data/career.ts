...
export const careerPhases: CareerPhase[] = [
  ...
  },
  {
    ...
    impact:
      "60+ greenfield builds and 250+ brownfield upgrades on bare-metal — concurrent Airship trains 2.6→2.12 — plus SRE for Microsoft MFA against strict SLOs.",
    techSpecs: [
      "Airship (Drydock, Deckhand, Pegleg, Armada, Promenade, Shipyard)",
      "OpenStack-Helm",
    ...
    subProjects: [
      {
        ...
        highlights: [
          "Delivered 60+ greenfield builds and 250+ brownfield upgrades of bare-metal Kubernetes sites — running concurrent Airship release trains across versions 2.6 → 2.12 with zero-touch cert rotation and compliance-driven updates.",
          "Went beyond deployment — self-taught and read the source of every Airship component (Drydock, Deckhand, Pegleg, Armada, Promenade, Shipyard) and operated fluently across both CLI and Web API.",
          "Authored pipeline-as-code with Airship seed and superseed files — Python tooling generating encrypted site manifests (topology, VLANs, IP/CIDR ranges, API tokens, SSH keys) via Pegleg salt + passphrase.",
          "Ran SR-IOV high-performance networking through node-level DaemonSets connecting at the server level — the same class of low-latency fabric used to interconnect GPU clusters.",
          "Built and maintained the Harbor container registry (Cloud Harbor) — including upgrades and lifecycle.",
          "Automated SSL/TLS certificate provisioning via Keyfactor (Python) and generated all cluster certificates with Pegleg before infrastructure even existed.",
          "Managed CI/CD (Git, Docker, Jenkins, ECR) for fleet-wide health checks, upgrades, and RAID workflows; updated Keystone RBAC webhooks for least-privilege Kubernetes access.",
          "Defined and tracked SLIs/SLOs; monitored fleet health with Nagios/Kibana, drove RCA and incident reports, and authored architecture and runbook documentation.",
        ],
      },
      {
...
export const techMatrix: TechCategory[] = [
  ...
  },
  {
    ...
    icon: Brain,
    color: "#14B8A6",
    items: ["GPT-4", "Llama 3.X", "Phi 3.5", "RAG", "Vector DBs", "KAITO (GPU Serving)", "LLMOps"],
  },
  {
    category: "Cloud",
    icon: Cloud,
  ...
  },
  {
    ...
    icon: BarChart3,
    color: "#D97706",
    items: ["SLIs / SLOs", "DataDog", "Splunk", "Nagios", "Kibana", "ThousandEyes", "Akamai", "Geneva"],
  },
  {
    category: "Infrastructure",
    icon: Network,
    color: "#047857",
    items: ["SR-IOV", "Harbor Registry", "Keyfactor (Certs)", "Ceph", "Calico", "Nginx", "IIS", "Active Directory"],
  },
  {
...
export const bentoHighlights: BentoItem[] = [
  ...
  },
  {
    ...
    value: "250+",
    subtitle: "60+ greenfield · 250+ brownfield (bare-metal)",
    icon: Globe,
    color: "#2563EB",
    span: "wide",
  },
